...
@section('content')
    <h5 class="mr-auto">My task list</h5>
    <hr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" role="group" aria-label="task operations">
                            ...
                            <a href="{{ route('userTask', ['task' => $task]) }}" type="button"
                               class="btn btn-outline-dark" title="Attach user">
                            ...
                            <a href="{{ route('taskEdit', ['task' => $task]) }}" type="button"
                               class="btn btn-outline-dark" title="Update">
                            ...
                            <a href="{{ route('taskDelete', ['task' => $task]) }}" type="button"
